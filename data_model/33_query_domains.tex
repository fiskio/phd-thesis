...
\underline{\textsc{Example}}:~Figure~\ref{fig:query_fanout} shows a query that calculates the occurrence
...
% The next section will describe the \emph{Source Information Content} (\sic) quality metric developed in
