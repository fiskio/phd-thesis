...
I will first describe a novel metric called \textit{Source Information Content} (\sic), which is a
...
\begin{comment}
\subsection***{Source Information Content}
...
a new metric called \textit{Source Information Content} (\sic) that gives a hint about the amount of
...
the dependability of that data. \textit{Source Information Content} tries to do achieve
...
Other proposal for an operator independent approach exists. The \textit{network imprecision}  metric
