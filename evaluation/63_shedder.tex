...
% the system.
% The policy strives to equalise the SIC values achieved by the result tuples of all queries.
...
% That using the SIC metric the fair shedder is able to use source data
